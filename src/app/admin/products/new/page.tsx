                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl><Textarea rows={8} placeholder="Provide detailed information about the product. You can use Markdown here for formatting." {...field} /></FormControl>
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <FormControl><Input placeholder="e.g., Enter your text here" {...field} /></FormControl>
                                                    </FormItem>
                                                )}
                                            />
                                        )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl><Input placeholder="e.g., Premium Business Cards" {...field} /></FormControl>
