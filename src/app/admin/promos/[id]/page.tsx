    ...
    useEffect(() => {
        if (promo) {
            form.reset({
                ...
                titleColor: promo.titleColor || '#000000',
                descriptionColor: promo.descriptionColor || '#666666',
                ctaBackgroundColor: promo.ctaBackgroundColor || '#3b82f6',
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Update the content for your promotion.</CardDescription>
                            </CardHeader>
